...
router.post('/login', login_request_1.loginRequest(), validatorHelper_1.validate, Auth.loginAdmin);
router.get('/profile', api_middleware_1.default(['admin']), Auth.profile);
